...
$env:REACT_APP_API_PROXY_URL="https://edgeenglish.net/php_api_proxy/secure-api-proxy.php"
...
echo "REACT_APP_API_PROXY_URL=https://edgeenglish.net/php_api_proxy/secure-api-proxy.php" >> .env.local
...
**예상 결과**: `https://edgeenglish.net/php_api_proxy/secure-api-proxy.php` 포함
