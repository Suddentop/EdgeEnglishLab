        ...
        <div className="footer-content">
          <div className="footer-left">
            <div className="company-info">
              <p className="company-name">Edge English Lab</p>
              {/* 법인에서 개인사업자로 이름 변경 <p className="company-name">주식회사 제이커머스</p> */}
              <p className="company-name">제이커머스</p>
              <p className="company-details">
                {/* 주소 변경 <인천광역시 연수구 연구단지로55번길 16, 602호<br /> */}
                인천광역시 연수구 해송로30번길20, 406-702<br />
                {/* 이메일 변경 <jcomtax@naver.com */}
                jcsbiz@naver.com
              </p>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <ul>
                ...
                <li>③ "아이디(ID)"라 함은 "회원"의 식별과 "서비스" 이용을 위하여 "회원"이 제공한 이메일 주소를 의미합니다.</li>
                <li>④ "비밀번호"라 함은 "회원"이 부여 받은 "아이디(이메일)"와 일치되는 "회원"임을 확인하고 비밀보호를 위해 "회원" 자신이 정한 문자 또는 숫자의 조합을 의미합니다.</li>
        ...
        <div className="modal-overlay" onClick={() => setShowPrivacy(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <ul>
                <li>1) <strong>필수항목:</strong> 이름, 아이디(이메일), 비밀번호, 이메일주소, 닉네임</li>
              ...
              <ul>
                ...
                <ul>
                  <li><strong>보존항목:</strong> 이용자가 제공한 이름, 아이디(이메일), 이메일 주소</li>
