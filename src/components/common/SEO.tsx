...
const SEO: React.FC<SEOProps> = ({ title, description }) => {
  useEffect(() => {
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', title ? `${title} | EngQuiz` : defaultTitle);
    }
