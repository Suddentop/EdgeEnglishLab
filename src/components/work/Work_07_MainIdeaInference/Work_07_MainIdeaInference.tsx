            ...
            {quizzes.map((quiz, idx) => {
              ...
              return (
                <div key={quizId} className="quiz-item-card" style={{ 
                  ...
                  <div className="quiz-item-header work07-header" style={{ 
                    marginBottom: '1rem', 
                    display: 'flex', 
                    alignItems: 'center', 
                  ...
                  <div className="problem-instruction work07-instruction" style={{
                    fontWeight: 500, 
                    fontSize: '0.95rem', 
                    background: '#f5f5f5', 
                    color: '#000', 
                  ...
                  <div className="problem-passage work07-passage" style={{
                    fontSize: '1rem',
                    lineHeight: 1.7,
                    margin: '0 0 0 0',
                    background: '#ffffff',
                  ...
                  <div className="problem-options work07-options" style={{
                    ...
                    {quiz.options.map((opt, i) => (
                      <div key={i} className="option work07-option" style={{
                        display: 'block',
                        fontSize: '1rem',
                        margin: '0.5rem 0',
                        padding: '0 1rem',
                  ...
                  {quiz.translation && (
                    <div className="translation-section" style={{ marginTop: '1rem' }}>
                      ...
                      <div className="translation-content work07-translation" style={{
                        background: '#F5F5F5',
