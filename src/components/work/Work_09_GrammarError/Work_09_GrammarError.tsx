...
const Work_09_GrammarError: React.FC = () => {
  ...
  const executeQuizGeneration = async () => {
    ...
    try {
      ...
      console.error('어법 오류 문제 생성 오류:', err);
      ...
      <div>
        <div className="quiz-display no-print">
          <div className="quiz-header">
            <h2 className="no-print">#09. 어법 변형 문제 (총 {quizzes.length}문제)</h2>
            ...
            {quizzes.map((quiz, idx) => {
              ...
              return (
                <div key={quizId} className="quiz-item-card" style={{ 
                  ...
                  <div className="quiz-item-header work09-header" style={{ 
                    marginBottom: '1rem', 
                    display: 'flex', 
                    alignItems: 'center', 
                  ...
                  <div className="problem-instruction work09-instruction" style={{
                    fontWeight: 500, 
                    fontSize: '0.95rem', 
                    background: '#f5f5f5', 
                    color: '#000', 
                  ...
                  <div className="problem-passage work09-passage" style={{
                    fontSize: '1rem',
                    lineHeight: 1.7,
                    margin: '0 0 0 0',
                    background: '#ffffff',
                  ...
                  <div className="problem-options work09-options" style={{
                    ...
                    {quiz.options.map((opt, i) => (
                      <div key={i} className="option work09-option" style={{
                        display: 'block',
                        fontSize: '1rem',
                        margin: '0.5rem 0',
                        padding: '0 1rem',
                        ...
                        {`①②③④⑤`[i] || `${i+1}.`} {opt}
                        {quiz.answerIndex === i && (
                          <span style={{ color: '#0066cc', fontWeight: 'bold' }}> (정답)</span>
                        )}
                      </div>
                    ))}
                  </div>
                  ...
                  {quiz.translation && (
                    <div className="translation-section" style={{ marginTop: '1rem' }}>
                      ...
                      <div className="translation-content work09-translation" style={{
                        background: '#F5F5F5',
  ...
  return (
    <div className="quiz-generator">
      ...
      <PointDeductionModal
        ...
        workTypeName={`어법 변형 문제 생성 (${items.filter(i => i.text.length >= 10).length}문제)`}
