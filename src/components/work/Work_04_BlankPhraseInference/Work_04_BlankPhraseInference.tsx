                ...
                <div className="quiz-content">
                  ...
                  {(pageLayoutInfo.page1Content.includes('C') || pageLayoutInfo.page1Content === 'C') && (
                    <>
                      ...
                      <div className="work04-print-answer-translation korean-translation" style={{fontSize:'0.5rem !important', lineHeight:'1.7', padding:'1rem', background:'#F1F8E9', borderRadius:'8px', fontFamily:'inherit', color:'#222', marginBottom:'1.2rem'}}>
