    ...
    if (isSingleWork && (typeId === '07' || typeId === '08')) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          const styleElement = document.getElementById(typeId === '07' ? 'print-style-work07-landscape' : 'print-style-work08-landscape');
          if (styleElement) {
            styleElement.remove();
          }
